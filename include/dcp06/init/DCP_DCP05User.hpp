...
namespace DCP
{
    ...
    class DCP05UserControllerC : public GUI::ControllerC
    {
        public:
        ...
        private:
            ...
            DCP05UserControllerC( const DCP05UserControllerC& oDCP05UserController )
            {
            ...
            // Remarks    : not implemented
            DCP05UserControllerC& operator=( const DCP05UserControllerC& oDCP05UserController )
            {
                USER_APP_VERIFY( false );
                return *this;
            }

            DCP05UserDlgC* m_pDlg;
    };


	class DCP05UserDlgC:public GUI::StandardDialogC, public GUI::ModelHandlerC
	{
		 public:
