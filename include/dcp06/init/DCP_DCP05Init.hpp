...
namespace DCP
{
	...
	class DCP05InitDlgC : /*public OBS::CommandC,*/ public GUI::StandardDialogC, public GUI::ModelHandlerC
    {
        public:
            ...
            DCP05InitDlgC(bool disableFileStorage = true);
        ...
        protected:
			...
			*/
			...
			//OBS_DECLARE_EXECUTE(DCP05InitDlgC);
...
// Description: Tabbed controller for the Hello World application
    class DCP05InitControllerC : public GUI::ControllerC , public OBS::CommandC
    {
        public:

            // Description: Constructor
            DCP05InitControllerC(bool disableFileStorage = true);
        ...
        private:
			...
			//DCP05InitControllerC( const DCP05InitControllerC& oDCP05InitController )
   //         {
   ...
   //         }
            ...
            // Remarks    : not implemented
            DCP05InitControllerC& operator=( const DCP05InitControllerC& oDCP05InitController )
            {
                USER_APP_VERIFY( false );
                return *this;
            }

            DCP05InitDlgC* m_pDlg;

			OBS_DECLARE_EXECUTE(DCP05InitControllerC);
