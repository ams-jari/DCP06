...
namespace DCP
{
	...
	class DCP05ModelC;
	class DCP05MeasDlgC;
	class DCP05MeasModelC;
	//class DCPSurveyModelC; 

    // Description: Tabbed controller for the Hello World application
	class DCP05MeasControllerC : public GUI::ControllerC, public TBL::MeasurementC//, public GUI::StandardDialogC
    {
        public:

            // Description: Constructor
            DCP05MeasControllerC(DCP05ModelC *pDCP05Model);
			~DCP05MeasControllerC();
        ...
        private:
            ...
            DCP05MeasControllerC( const DCP05MeasControllerC& oDCP05MeasController )
            {
            ...
            // Remarks    : not implemented
            DCP05MeasControllerC& operator=( const DCP05MeasControllerC& oDCP05MeasController )
            {
                USER_APP_VERIFY( false );
                return *this;
            }

            DCP05MeasDlgC* m_pDlg;
	...
	class DCP05MeasDlgC:public GUI::StandardDialogC, public GUI::ModelHandlerC, public OBS::CommandC
	{
		 public:
		   ...
		   DCP05MeasDlgC(DCP05ModelC *pDCP05Model);

            // Description: Destructor
            virtual ~DCP05MeasDlgC();
            ...
            virtual bool SetModel( GUI::ModelC* pModel );
			DCP05MeasModelC* GetDataModel() const;
	...
	protected:
			...
			OBS_DECLARE_EXECUTE(DCP05MeasDlgC);
   ...
   class DCP05MeasModelC : public GUI::ModelC
    {
        public:
