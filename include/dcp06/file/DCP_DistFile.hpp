...
namespace DCP
{
    ...
    // Forward declaration
    class DCP05ModelC;
	class DCP05DistFileDlgC;
	class DCP05DistFileModelC;

	class CdfFileFunc;

    // Description: Tabbed controller for the Hello World application
    class DCP05DistFileControllerC : public GUI::ControllerC
    {
        public:

            // Description: Constructor
            DCP05DistFileControllerC(DCP05ModelC* pDCP05Model);
			~DCP05DistFileControllerC();
        ...
        private:
            ...
            DCP05DistFileControllerC( const DCP05DistFileControllerC& oDCP05DistFileController )
            {
            ...
            // Remarks    : not implemented
            DCP05DistFileControllerC& operator=( const DCP05DistFileControllerC& oDCP05DistFileController )
            {
                USER_APP_VERIFY( false );
                return *this;
            }

            DCP05DistFileDlgC* m_pDlg;
			DCP05DistFileModelC* m_pDataModel;
			DCP05ModelC* m_pDCP05Model;
    };


    class DCP05DistFileDlgC:public GUI::StandardDialogC, public GUI::ModelHandlerC
	{
	 public:
		   ...
		   DCP05DistFileDlgC(DCP05DistFileModelC* pModel);

            // Description: Destructor
            virtual ~DCP05DistFileDlgC();
	...
	class DCP05DistFileModelC : public GUI::ModelC
    {
        public:

            // Description: Constructor
            //
            DCP05DistFileModelC(DCP05ModelC* pDCP05Model);

            // Description: Destructor
            //
            virtual ~DCP05DistFileModelC();
    ...
    class CdfFileFunc
    {
        public:
			...
			CdfFileFunc(boost::filesystem::path* FileInfo,DCP05ModelC* pDCP05Model);//CPI::FileInfoC* FileInfo);
			CdfFileFunc(DCP05ModelC* pDCP05Model);
