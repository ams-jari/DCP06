...
DCP::MeasureDialog::MeasureDialog(DCP::Model *pModel):GUI::ModelHandlerC(),GUI::StandardDialogC(),
	m_pPointNo(0),m_pPointId(0),m_pX(0),m_pY(0),m_pZ(0)/*,m_pInfo(0)*/,m_pModel(pModel),
	m_pPointIdObserver(OBS_METHOD_TO_PARAM0(MeasureDialog, OnPointIdChanged), this),
...
DCP::MeasureDialog::~MeasureDialog()
{
	 //m_pTimer.KillTimer();
	 if(m_pCommon)
	 {
...
void DCP::MeasureDialog::UpdateData()
{
}
...
{
    // Verify type
    DCP::MeasureModel* pModel = dynamic_cast< DCP::MeasureModel* >( pModel );
...
void DCP::MeasureDialog::SelectPoint(StringC strSelectedPoint,short iSelectedPointId)
{
...
void DCP::MeasureDialog::delete_point()
{
...
// ================================================================================================
void DCP::MeasureDialog::next_point()
{
	if(GetDataModel()->m_iCurrentPoint < GetDataModel()->m_iPointsCount)
...
// ================================================================================================
void DCP::MeasureDialog::prev_point()
{
	if(GetDataModel()->m_iCurrentPoint > 1)
		GetDataModel()->m_iCurrentPoint--;
...
void DCP::MeasureDialog::update_meas_values(double x, double y, double z, short /*DCP_POINT_STATUS*/ status)
{
	Common common(m_pModel);
...
// ================================================================================================
void DCP::MeasureDialog::add_point()
{
...
// ================================================================================================
void DCP::MeasureDialog::OnPointIdChanged( int unNotifyCode, int ulParam2)
{
	// save pointid
    ...
    : m_pDlg( nullptr ),m_pModel(pModel), m_pCommon(0),poVideoDlg(0),m_bCamera(false)
{
    ...
    // Create a dialog
    m_pDlg = new DCP::MeasureDialog(pModel);  //lint !e1524 new in constructor for class 
...
void DCP::MeasureController::show_function_keys()
{
	ResetFunctionKeys();
...
DCP::MeasureController::~MeasureController()
{
	if(m_pCommon)
	{
		delete m_pCommon;
...
DCP::MeasureModel* DCP::MeasureDialog::GetDataModel() const
{
    return (DCP::MeasureModel*) GetModel(); //lint !e1774 Could use dynamic_cast to 
...
void DCP::MeasureController::OnF1Pressed()
{
	if(m_bCamera)
	{
		m_bCamera = false;
...
void DCP::MeasureController::OnSHF1Pressed()
{
	/* CAPTIVATE
	if( ABL::VideoDialogC::IsCameraAvailable(CFA::CT_OVC) )
	{
...
// Description: Handle change of position values
void DCP::MeasureController::OnSHF2Pressed()
{
	m_pDlg->delete_point();
}

// INIT
void DCP::MeasureController::OnSHF3Pressed()
{
...
void DCP::MeasureController::OnSHF4Pressed()
{
	/*
	// SPECIAL MENU
...
// PID
void DCP::MeasureController::OnSHF5Pressed()
{
		if (m_pDlg == nullptr)
	    {
		    USER_APP_VERIFY( false );
...
void DCP::MeasureController::OnSHF6Pressed()
{
...
void DCP::MeasureController::OnActiveDialogClosed( int lDlgID, int lExitCode )
{
...
void DCP::MeasureController::OnActiveControllerClosed( int lCtrlID, int lExitCode )
{
	// SELECT POINT
...
void DCP::MeasureController::OnControllerActivated(void)
{
//	ActivateMeasurement();
}
void DCP::MeasureController::OnControllerClosed(int lExitCode)
{
