...
DCP::DemoLicense::DemoLicense(DCP::Model* pModel): m_pModel(pModel)
{
...
// ****************************************************************************************
bool DCP::DemoLicense::is_license_ok(char* keycode, DateTime startDate)
{
	if(keycode[0] == '\0')
		return false;
	...
	else
	{
		...
		if(strcmp(oldCode, m_pModel->sKeyCodeDemo1) == 0) // last one  is ok
		{
...
// ****************************************************************************************
int DCP::DemoLicense::get_available_days(char* keycode, DateTime startDate)
{
	int days  = 0;
...
// ****************************************************************************************
void DCP::DemoLicense::get_code_demo(int demoNumber, char *sCode)
{
int nro=1L;
char *p, *p1,*p2;
char temp[20];
