...
DCP::DCP05MeasDlgC::DCP05MeasDlgC(DCP::DCP05ModelC *pDCP05Model):GUI::ModelHandlerC(),GUI::StandardDialogC(),
	m_pPointNo(0),m_pPointId(0),m_pX(0),m_pY(0),m_pZ(0)/*,m_pInfo(0)*/,m_pDCP05Model(pDCP05Model),
	m_pPointIdObserver(OBS_METHOD_TO_PARAM0(DCP05MeasDlgC, OnPointIdChanged), this),
...
DCP::DCP05MeasDlgC::~DCP05MeasDlgC()
{
	 //m_pTimer.KillTimer();
	 if(m_pCommon)
	 {
...
void DCP::DCP05MeasDlgC::OnInitDialog(void)
{
...
void DCP::DCP05MeasDlgC::OnDialogActivated()
{
...
//void DCP::DCP05MeasDlgC::OnTimer(void)
//{
...
void DCP::DCP05MeasDlgC::UpdateData()
{
}

// Description: refresh all controls
void DCP::DCP05MeasDlgC::RefreshControls()
{
...
bool DCP::DCP05MeasDlgC::SetModel( GUI::ModelC* pModel )
{
    // Verify type
    DCP::DCP05MeasModelC* pDCP05Model = dynamic_cast< DCP::DCP05MeasModelC* >( pModel );
...
void DCP::DCP05MeasDlgC::SelectPoint(StringC strSelectedPoint,short iSelectedPointId)
{
...
void DCP::DCP05MeasDlgC::delete_point()
{

	StringC strMsg;
	strMsg.LoadTxt(AT_DCP05,M_DCP_DELETE_ALL_POINTS_TOK);
...
// ================================================================================================
void DCP::DCP05MeasDlgC::next_point()
{
	if(GetDataModel()->m_iCurrentPoint < GetDataModel()->m_iPointsCount)
...
// ================================================================================================
void DCP::DCP05MeasDlgC::prev_point()
{
	if(GetDataModel()->m_iCurrentPoint > 1)
		GetDataModel()->m_iCurrentPoint--;
...
void DCP::DCP05MeasDlgC::update_meas_values(double x, double y, double z, short /*DCP_POINT_STATUS*/ status)
{
	DCP05CommonC common(m_pDCP05Model);
...
// ================================================================================================
void DCP::DCP05MeasDlgC::add_point()
{
...
// ================================================================================================
void DCP::DCP05MeasDlgC::OnPointIdChanged( int unNotifyCode, int ulParam2)
{
	// save pointid
...
// DCP05UserControllerC
// 
DCP::DCP05MeasControllerC::DCP05MeasControllerC(DCP::DCP05ModelC *pDCP05Model)
    : m_pDlg( NULL ),m_pDCP05Model(pDCP05Model), m_pCommon(0),poVideoDlg(0),m_bCamera(false)
{
    // Set title token
    // The appropriate application ID has to be set because 'C_DCP_APPLICATION_NAME_TOK'
    // is a token from the text database 'DCP05.men'
    SetTitle(StringC( AT_DCP05, T_DCP_MEAS_TOK /*C_DCP_APPLICATION_NAME_TOK */));

    // Create a dialog
    m_pDlg = new DCP::DCP05MeasDlgC(pDCP05Model);  //lint !e1524 new in constructor for class 
...
void DCP::DCP05MeasControllerC::show_function_keys()
{
	ResetFunctionKeys();
...
DCP::DCP05MeasControllerC::~DCP05MeasControllerC()
{
	if(m_pCommon)
	{
		delete m_pCommon;
...
DCP::DCP05MeasModelC* DCP::DCP05MeasDlgC::GetDataModel() const
{
    return (DCP::DCP05MeasModelC*) GetModel(); //lint !e1774 Could use dynamic_cast to 
                                                //downcast polymorphic type
}

// Description: Route model to everybody else
bool DCP::DCP05MeasControllerC::SetModel( GUI::ModelC* pModel )
{
...
void DCP::DCP05MeasControllerC::OnF1Pressed()
{
	if(m_bCamera)
	{
		m_bCamera = false;
...
// Description: F2
// ================================================================================================
void DCP::DCP05MeasControllerC::OnF2Pressed()
{
	//// DIST
	if(m_pCommon->check_edm_mode())
	{
...
// NEXT POINT
void DCP::DCP05MeasControllerC::OnF3Pressed()
{
	m_pDlg->next_point();
}
// previous point
void DCP::DCP05MeasControllerC::OnF4Pressed()
{
	m_pDlg->prev_point();
}

// Add point
void DCP::DCP05MeasControllerC::OnF5Pressed()
{
	m_pDlg->add_point();
}
// Description: Handle change of position values
void DCP::DCP05MeasControllerC::OnF6Pressed()
{
    if (m_pDlg == NULL)
    {
        USER_APP_VERIFY( false );
...
void DCP::DCP05MeasControllerC::OnSHF1Pressed()
{
	/* CAPTIVATE
	if( ABL::VideoDialogC::IsCameraAvailable(CFA::CT_OVC) )
	{
...
// Description: Handle change of position values
void DCP::DCP05MeasControllerC::OnSHF2Pressed()
{
	m_pDlg->delete_point();
}

// INIT
void DCP::DCP05MeasControllerC::OnSHF3Pressed()
{
...
void DCP::DCP05MeasControllerC::OnSHF4Pressed()
{
	/*
	// SPECIAL MENU
...
// PID
void DCP::DCP05MeasControllerC::OnSHF5Pressed()
{
		if (m_pDlg == NULL)
	    {
		    USER_APP_VERIFY( false );
...
void DCP::DCP05MeasControllerC::OnSHF6Pressed()
{
...
void DCP::DCP05MeasControllerC::OnActiveDialogClosed( int lDlgID, int lExitCode )
{
...
void DCP::DCP05MeasControllerC::OnActiveControllerClosed( int lCtrlID, int lExitCode )
{
	// SELECT POINT
...
void DCP::DCP05MeasControllerC::OnControllerActivated(void)
{
//	ActivateMeasurement();
}
void DCP::DCP05MeasControllerC::OnControllerClosed(int lExitCode)
{
...
DCP::DCP05MeasModelC::DCP05MeasModelC()
{
	m_iMinPoint = 0;
	m_iMaxPoint = 0;
	m_iPointsCount = 0;
