...
DCP::AimController::AimController(double x, double y, double z, short cds):m_dX(x), m_dY(y), m_dZ(z),
...
// ================================================================================================
DCP::AimController::~AimController()
{
	if(m_pCommon)
	{
		delete m_pCommon;
...
void DCP::AimController::set_values(double x, double y, double z, short cds)
{
	m_dX = x;
	m_dY = y;
	m_dZ = z;
...
// ================================================================================================
void DCP::AimController::OnControllerActivated(void)
{
	// AIM
...
void DCP::AimController::Run(void)
{
		...
		if(m_pModel->active_tool > 0)
		{
			...
			{
				point1[0] = point1[0] + m_pModel->active_tool_x;
				point1[1] = point1[1] + m_pModel->active_tool_y;
				point1[2] = point1[2] + m_pModel->active_tool_z;
...
// Description: set_aim
// ================================================================================================
short DCP::AimController::set_aim()
{
	
		// Object coordinate system, POM
		if (m_iCds/*m_pModel->active_coodinate_system*/ == OCSP)
		{
			ptrans(point1, &m_pModel->ocsp_inv_matrix[0], &point2);
		}
		
		// Object coordinate system, CHST 
		else if (m_iCds/*m_pModel->active_coodinate_system*/ == OCSC)
		{
			ptrans(point1, &m_pModel->ocsc_inv_matrix[0], &point2);
		}

		// Object coordinate system, DOM 
		else if (m_iCds/*m_pModel->active_coodinate_system*/ == OCSD)
		{
			ptrans(point1, &m_pModel->ocsd_inv_matrix[0], &point2);
		}

		// Object coordinate system, USER DEFINED 
		else if (m_iCds/*m_pModel->active_coodinate_system*/ == OCSU)
		{
			ptrans(point1, &m_pModel->ocsu_inv_matrix[0], &point2);
		}
		
		// Device coordinate system 
		else
		{
			ptrans(point1, &m_pModel->dcs_inv_matrix[0], &point2);
		}
		...
		*/		
		...
		TBL::PositTelescopeControllerC* poPositTelescope = new TBL::PositTelescopeControllerC();
		poPositTelescope->EnableMessageBox(true);
		if(GetController(DO_AIM_CONTROLLER) == nullptr)
		{
...
// ================================================================================================
bool DCP::AimController::SetModel( GUI::ModelC* pModel )
{
...
// ================================================================================================
void DCP::AimController::OnActiveDialogClosed( int lDlgID, int lExitCode )
{
	/*
...
// ================================================================================================
void DCP::AimController::OnActiveControllerClosed( int lCtrlID, int lExitCode )
{
	// 
	...
	{
		if(m_pModel->active_tool > 0 &&  lExitCode == EC_KEY_CONT)
		{	
			point1[0] = point1[0] + m_pModel->active_tool_x;
			point1[1] = point1[1] + m_pModel->active_tool_y;
			point1[2] = point1[2] + m_pModel->active_tool_z;
