...
***************************************************************/
short DCP::CalcChangeStation::defined_bestFit_points(/*point_buff_ *point_OCS,*/ short *lastpoint)
{
...
short sta_OCS,sta_DCS;
		...
		*/
		...
		/**************************************************************
		  2 points levelled
		***************************************************************/
		/*if(points_defined == 2 && A321_ROTATION == false
			&& m_pModel->align321_hz_plane  && m_pBestFitModel->bestFit_chst != 0)*/
		...
		***************************************************************/
		...
		/*else if(points_defined < 2 &&
				A321_ROTATION == false &&
				m_pModel->align321_hz_plane && 
				m_pBestFitModel->bestFit_chst == 1)*/
		...
		***************************************************************/
		/*
				 ...
				 A321_ROTATION ||
				 m_pModel->align321_hz_plane == false  ||
