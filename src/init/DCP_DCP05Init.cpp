...
#include <dcp06/init/DCP_DCP05User.hpp>
...
DCP::DCP05InitDlgC::DCP05InitDlgC(bool disableFileStorage) :// m_pCombo( NULL ), m_pCombo2(NULL), m_pComboBox(NULL),
	//m_pComboBoxObserver(OBS_METHOD_TO_PARAM0(DCP05InitDlgC, OnComboBoxChanged), this),
...
{ 
	...
	m_sMMText.LoadTxt(AT_DCP05,V_DCP_MM_TOK);
	m_sINCHText.LoadTxt(AT_DCP05,V_DCP_INCH_TOK);
	m_sFEETText.LoadTxt(AT_DCP05,V_DCP_FEET_TOK);
}
...
//
void DCP::DCP05InitDlgC::OnInitDialog()
{
	...
	m_pTextTarget->SetText(StringC(AT_DCP05,P_DCP_TARGET_TOK));
	...
	m_pUser->SetId(eUser);
	m_pUser->SetText(StringC(AT_DCP05,P_DCP_USER_TOK));
	...
	m_pAtmCorr->SetText(StringC(AT_DCP05,P_DCP_ATM_CORRECTION_TOK));
	...
	m_p2Face->SetText(StringC(AT_DCP05,P_DCP_2FACE_MEAS_TOK));
	m_p2Face->GetComboBoxInputCtrl()->AddItem(StringC(AT_DCP05,V_DCP_NO_TOK),			NO);
	m_p2Face->GetComboBoxInputCtrl()->AddItem(StringC(AT_DCP05,V_DCP_ALL_TOK),		ALL);
	m_p2Face->GetComboBoxInputCtrl()->AddItem(StringC(AT_DCP05,V_DCP_DIST_TOK),		DIST);
	m_p2Face->GetComboBoxInputCtrl()->AddItem(StringC(AT_DCP05,V_DCP_ALL_MAN_TOK), 	ALL_MANUAL);
	m_p2Face->GetComboBoxInputCtrl()->AddItem(StringC(AT_DCP05,V_DCP_DIST_MAN_TOK),	DIST_MANUAL);
	...
	m_pFileStorage->SetText(StringC(AT_DCP05,P_DCP_FILE_STORAGE_TOK));
	#ifdef CS35
		m_pFileStorage->GetComboBoxInputCtrl()->AddItem(StringC(L"Local memory"),			LOCAL_MEMORY);
	#else
		m_pFileStorage->GetComboBoxInputCtrl()->AddItem(StringC(AT_DCP05,V_DCP_SD_CARD_TOK),			SD_CARD);
	#endif

	m_pFileStorage->GetComboBoxInputCtrl()->AddItem(StringC(AT_DCP05,V_DCP_USB_STICK_TOK),		USB_STICK);
	//m_p2Face->SetAutoColon(false);
	//m_p2Face->SetColonPosition(9*22);
	// m_p2Face->SetTextWidth(9*40); CAPTIVATE
	// m_p2Face->SetWidth(30); CAPTIVATE
	...
	m_pDesignValues->SetText(StringC(AT_DCP05,P_DCP_DESIGN_VALUES_IN_USE_TOK));
	m_pDesignValues->GetComboBoxInputCtrl()->AddItem(StringC(AT_DCP05,V_DCP_NO_TOK), NO);
	m_pDesignValues->GetComboBoxInputCtrl()->AddItem(StringC(AT_DCP05,V_DCP_YES_TOK),	 YES);
	...
	m_pOverwriteInfo->SetText(StringC(AT_DCP05,P_DCP_OVERWRITE_INFO_TOK));
	m_pOverwriteInfo->GetComboBoxInputCtrl()->AddItem(StringC(AT_DCP05,V_DCP_NO_TOK), NO);
	m_pOverwriteInfo->GetComboBoxInputCtrl()->AddItem(StringC(AT_DCP05,V_DCP_YES_TOK), YES);
	...
	m_ToolInfo->SetText(StringC(AT_DCP05,P_DCP_TOOL_INFO_TOK));
	m_ToolInfo->GetComboBoxInputCtrl()->AddItem(StringC(AT_DCP05,V_DCP_NO_TOK), NO);
	m_ToolInfo->GetComboBoxInputCtrl()->AddItem(StringC(AT_DCP05,V_DCP_YES_TOK), YES);
	...
	m_pAutoIncrement->SetText(StringC(AT_DCP05,P_DCP_AUTO_INCREMENT_TOK));
	m_pAutoIncrement->GetComboBoxInputCtrl()->AddItem(StringC(AT_DCP05,V_DCP_NO_TOK),	 NO);
	m_pAutoIncrement->GetComboBoxInputCtrl()->AddItem(StringC(AT_DCP05,V_DCP_YES_TOK),	 YES);
	...
	m_pAverageCount->SetText(StringC(AT_DCP05,P_DCP_AVERAGE_COUNT_TOK));
	...
	m_pLeftRightHand->SetText(StringC(AT_DCP05,P_DCP_LEFT_RIGHT_HAND_TOK));
	m_pLeftRightHand->GetComboBoxInputCtrl()->AddItem(StringC(AT_DCP05,V_DCP_LEFTHAND_TOK), LEFTHAND);
	m_pLeftRightHand->GetComboBoxInputCtrl()->AddItem(StringC(AT_DCP05,V_DCP_RIGHTHAND_TOK), RIGHTHAND);
	...
	m_pAutoMatch->SetText(StringC(AT_DCP05,P_DCP_AUTOMATCH_TOK));
	m_pAutoMatch->GetComboBoxInputCtrl()->AddItem(StringC(AT_DCP05,V_DCP_NO_TOK), NO);
	m_pAutoMatch->GetComboBoxInputCtrl()->AddItem(StringC(AT_DCP05,V_DCP_YES_TOK), YES);
	...
	m_pAmsLog->SetText(StringC(AT_DCP05,P_DCP_AMS_LOG_TOK));
	m_pAmsLog->GetComboBoxInputCtrl()->AddItem(StringC(AT_DCP05,V_DCP_NO_TOK), NO);
	m_pAmsLog->GetComboBoxInputCtrl()->AddItem(StringC(AT_DCP05,V_DCP_YES_TOK), YES);
	...
	m_pSaveTool->SetText(StringC(AT_DCP05,P_DCP_SAVE_TOOL_TOK));
	m_pSaveTool->GetComboBoxInputCtrl()->AddItem(StringC(AT_DCP05,V_DCP_NO_TOK), NO);
	m_pSaveTool->GetComboBoxInputCtrl()->AddItem(StringC(AT_DCP05,V_DCP_YES_TOK), YES);
...
bool DCP::DCP05InitDlgC::SetModel( GUI::ModelC* pModel )
{
    // Verify type
...
void DCP::DCP05InitDlgC::RefreshControls()
{
		...
		m_pLeftRightHand && m_pAutoMatch && m_pAmsLog && m_pSaveTool && m_pFileStorage)
	{
		...
		// USER	
		if(!GetDCP05Model()->m_sUser.IsEmpty())
			m_pUser->GetStringInputCtrl()->SetString(GetDCP05Model()->m_sUser);
		else
		...
		else if(GetDCP05Model()->m_nUnit == FEET)
			sUnit = m_sFEETText;

		else
			sUnit = m_sINCHText;

		short iDec = GetDCP05Model()->m_nDecimals;
		...
		m_p2Face->GetComboBoxInputCtrl()->SetSelectedId(GetDCP05Model()->m_n2FaceMeas);
		m_pDesignValues->GetComboBoxInputCtrl()->SetSelectedId(GetDCP05Model()->m_nDesignValues);
		m_pOverwriteInfo->GetComboBoxInputCtrl()->SetSelectedId(GetDCP05Model()->m_nOverWriteInfo);
		m_ToolInfo->GetComboBoxInputCtrl()->SetSelectedId(GetDCP05Model()->m_nToolInfo);
		m_pAutoIncrement->GetComboBoxInputCtrl()->SetSelectedId(GetDCP05Model()->m_nAutoIncrement);
		m_pAverageCount->GetComboBoxInputCtrl()->SetSelectedId(GetDCP05Model()->m_nAverageCount);
		m_pLeftRightHand->GetComboBoxInputCtrl()->SetSelectedId(GetDCP05Model()->m_nLeftRightHand);
		m_pAutoMatch->GetComboBoxInputCtrl()->SetSelectedId(GetDCP05Model()->m_nAutoMatch);
		m_pAmsLog->GetComboBoxInputCtrl()->SetSelectedId(GetDCP05Model()->m_nAmsLog);
		m_pSaveTool->GetComboBoxInputCtrl()->SetSelectedId(GetDCP05Model()->m_nSaveTool);

#ifdef CS35
		m_pFileStorage->GetComboBoxInputCtrl()->SetSelectedId(GetDCP05Model()->FILE_STORAGE1 == CPI::deviceLocalMemory ? LOCAL_MEMORY: USB_STICK );
#else
		m_pFileStorage->GetComboBoxInputCtrl()->SetSelectedId(GetDCP05Model()->FILE_STORAGE1 == CPI::deviceSdCard ? SD_CARD: USB_STICK );
#endif
...
void DCP::DCP05InitDlgC::UpdateData()
{
	//m_pTextTarget(0), 
	GetDCP05Model()->m_sUser = m_pUser->GetStringInputCtrl()->GetString();
    //m_pUnit(0),
	//m_pAtmCorr(0),
	GetDCP05Model()->m_n2FaceMeas		= m_p2Face->GetComboBoxInputCtrl()->GetSelectedId();
	GetDCP05Model()->m_nDesignValues	= m_pDesignValues->GetComboBoxInputCtrl()->GetSelectedId();
	GetDCP05Model()->m_nOverWriteInfo	= m_pOverwriteInfo->GetComboBoxInputCtrl()->GetSelectedId();
	GetDCP05Model()->m_nToolInfo		= m_ToolInfo->GetComboBoxInputCtrl()->GetSelectedId();
    GetDCP05Model()->m_nAutoIncrement	= m_pAutoIncrement->GetComboBoxInputCtrl()->GetSelectedId();
	GetDCP05Model()->m_nAverageCount	= m_pAverageCount->GetComboBoxInputCtrl()->GetSelectedId();
	GetDCP05Model()->m_nLeftRightHand	= m_pLeftRightHand->GetComboBoxInputCtrl()->GetSelectedId();
	GetDCP05Model()->m_nAutoMatch		= m_pAutoMatch->GetComboBoxInputCtrl()->GetSelectedId();
	GetDCP05Model()->m_nAmsLog			= m_pAmsLog->GetComboBoxInputCtrl()->GetSelectedId();
	GetDCP05Model()->m_nSaveTool		= m_pSaveTool->GetComboBoxInputCtrl()->GetSelectedId();

#ifdef CS35
	GetDCP05Model()->FILE_STORAGE1		= m_pFileStorage->GetComboBoxInputCtrl()->GetSelectedId() == LOCAL_MEMORY ? CPI::deviceLocalMemory : CPI::deviceUSB;
#else
	GetDCP05Model()->FILE_STORAGE1		= m_pFileStorage->GetComboBoxInputCtrl()->GetSelectedId() == SD_CARD ? CPI::deviceSdCard : CPI::deviceUSB;
#endif
...
DCP::DCP05ModelC* DCP::DCP05InitDlgC::GetDCP05Model() const
{
...
//void DCP::DCP05InitDlgC::OnComboBoxChanged(int unNotifyCode, int ulParam2)
//{
...
OBS_IMPLEMENT_EXECUTE(DCP::DCP05InitControllerC);
//-------------------------------------------------------------------------------------------------
// DCP05InitControllerC
// 
DCP::DCP05InitControllerC::DCP05InitControllerC(bool disableFileStorage)
    : m_pDlg( NULL ),m_pOnApplicationClosedObserver(OBS_METHOD_TO_PARAM0(DCP05InitControllerC, OnApplicationClosed), this)
{
    ...
    SetTitle(StringC( AT_DCP05, T_DCP_INIT_TOK /*C_DCP_APPLICATION_NAME_TOK */));

    // Create a dialog
    m_pDlg = new DCP::DCP05InitDlgC(disableFileStorage);  //lint !e1524 new in constructor for class 
	...
	vDef.strLable = StringC(AT_DCP05,K_DCP_USER_TOK);
	vDef.poOwner = this;
	SetFunctionKey(FK3, vDef);

	vDef.strLable = StringC(AT_DCP05,K_DCP_UNIT_TOK);
	vDef.poOwner = this;
	SetFunctionKey(FK4, vDef);
	
	vDef.strLable = StringC(AT_DCP05,K_DCP_PPM_TOK);
	vDef.poOwner = this;
...
DCP::DCP05InitControllerC::~DCP05InitControllerC()
{

}

// Description: Route model to everybody else
bool DCP::DCP05InitControllerC::SetModel( GUI::ModelC* pModel )
{
...
void DCP::DCP05InitControllerC::OnF1Pressed()
{
    if (m_pDlg == NULL)
    {
        USER_APP_VERIFY( false );
...
// TARGET
void DCP::DCP05InitControllerC::OnF2Pressed()
{
    if (m_pDlg == NULL)
    {
        USER_APP_VERIFY( false );
...
// Description: Handle change of position values
void DCP::DCP05InitControllerC::OnF3Pressed()
{
    if (m_pDlg == NULL)
    {
        USER_APP_VERIFY( false );
	...
	{
		(void)AddController( INIT_USER_CONTROLLER, new DCP::DCP05UserControllerC );
	}
	(void)GetController( INIT_USER_CONTROLLER )->SetModel(m_pDlg->GetDCP05Model());
	SetActiveController(INIT_USER_CONTROLLER, true);

}

void DCP::DCP05InitControllerC::OnF4Pressed()
{
    if (m_pDlg == NULL)
    {
        USER_APP_VERIFY( false );
	...
	{
		(void)AddController( INIT_UNIT_CONTROLLER, new DCP::DCP05UnitControllerC );
	}
	(void)GetController( INIT_UNIT_CONTROLLER )->SetModel( m_pDlg->GetDCP05Model());
	SetActiveController(INIT_UNIT_CONTROLLER, true);
}


// PPM
void DCP::DCP05InitControllerC::OnF5Pressed()
{
    if (m_pDlg == NULL)
    {
        USER_APP_VERIFY( false );
...
void DCP::DCP05InitControllerC::OnActiveDialogClosed( int /*lDlgID*/, int /*lExitCode*/ )
{
}

// Description: React on close of controller
void DCP::DCP05InitControllerC::OnActiveControllerClosed( int lCtrlID, int lExitCode )
{
...
void DCP::DCP05InitControllerC::OnApplicationClosed( int unNewApp,  int ulAppOwner)
{
