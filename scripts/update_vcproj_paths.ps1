...
$srcMap = @{
    ...
    '\.\.\\\.\.\\Src\\DCP_ResBestFit\.cpp'='..\..\src\orientation\DCP_ResBestFit.cpp'
    '\.\.\\\.\.\\Src\\DCP_BestFitSelectPoints\.cpp'='..\..\src\orientation\DCP_BestFitSelectPoints.cpp'
    ...
    '\.\.\\\.\.\\Src\\DCP_Calc321\.cpp'='..\..\src\calculation\DCP_Calc321.cpp'
    ...
    '\.\.\\\.\.\\Src\\DCP_CalcBestFit\.cpp'='..\..\src\calculation\DCP_CalcBestFit.cpp'
...
$hdrToDomain = @{
    ...
    'DCP_Alignment321Model.hpp'='core'; 'DCP_SpecialMenu.hpp'='core'; 'DCP_AutoMatch.hpp'='core'
    ...
    'DCP_ResPlane.hpp'='orientation'; 'DCP_ResLine.hpp'='orientation'; 'DCP_ResBestFit.hpp'='orientation'; 'DCP_BestFitSelectPoints.hpp'='orientation'
    ...
    'DCP_CalcDist.hpp'='calculation'; 'DCP_CalcDist2Points.hpp'='calculation'; 'DCP_Calc321.hpp'='calculation'; 'DCP_CalcLine.hpp'='calculation'
    'DCP_CalcLineController.hpp'='calculation'; 'DCP_CalcLineFit.hpp'='calculation'; 'DCP_CalcMenu.hpp'='calculation'
    'DCP_CalcPlane.hpp'='calculation'; 'DCP_CalcPlaneController.hpp'='calculation'; 'DCP_CalcBestFit.hpp'='calculation'
