...
$srcMap = @{
    ...
    '\\Src\\DCP_Alignment321Model.cpp'='\src\core\DCP_Alignment321Model.cpp'
    '\\Src\\DCP_SpecialMenu.cpp'='\src\core\DCP_SpecialMenu.cpp'
    '\\Src\\DCP_AutoMatch.cpp'='\src\core\DCP_AutoMatch.cpp'
...
foreach ($k in $srcMap.Keys) {
    $content = $content -replace [regex]::Escape($k), $srcMap[$k]
}
# Fix Src to src for math (case)
$content = $content -replace '\.\.\\\.\.\\Src\\math\\', '..\..\src\math\'

# Hdr to include/dcp06
$hdrMap = @{
    '\\Hdr\\'='\include\dcp06\core\'
}
# Headers are in different subdirs - do per-header mapping
$hdrToDomain = @{
...
foreach ($hdr in $hdrToDomain.Keys) {
    ...
    $content = $content -replace [regex]::Escape("..\..\Hdr\$hdr"), "..\..\include\dcp06\$domain\$hdr"
}
