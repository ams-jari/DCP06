...
$map = @{
    ...
    'DCP_SelectOnePoint'='dcp06/core'; 'DCP_PointBuffModel'='dcp06/core'; 'DCP_DomModel'='dcp06/core'
    ...
    'DCP_ResPlane'='dcp06/orientation'; 'DCP_ResLine'='dcp06/orientation'; 'DCP_ResPom'='dcp06/orientation'
    'DCP_PomSelectPoints'='dcp06/orientation'
    ...
    'DCP_CalcDist2Points'='dcp06/calculation'; 'DCP_CalcDom'='dcp06/calculation'; 'DCP_CalcLine'='dcp06/calculation'
    'DCP_CalcLineController'='dcp06/calculation'; 'DCP_CalcLineFit'='dcp06/calculation'; 'DCP_CalcMenu'='dcp06/calculation'
    'DCP_CalcPlane'='dcp06/calculation'; 'DCP_CalcPlaneController'='dcp06/calculation'; 'DCP_CalcPom'='dcp06/calculation'
